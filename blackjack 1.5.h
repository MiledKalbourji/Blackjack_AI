...
void Player:: addCardToHand(Card card) { // Add Card to players hand 
	hand.push_back(card); // 
...
void Game::dealInitialCards() {
    ...
    player.addCardToHand(deck.dealCard()); // adding cards to player's hands
    player.addCardToHand(deck.dealCard()); // we need two because there is two cards being dealt 
